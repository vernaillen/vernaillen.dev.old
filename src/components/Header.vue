          ...
          <router-link to="/" class="ud-w-full ud-block header-logo">
            <svg viewBox="0 0 754 276" width="100">
              <g fill="none" opacity="transparent">
                <path
                  class="fill-black dark:fill-primary"
          ...
          <div class="ud-flex ud-justify-end ud-items-center ud-pr-16 lg:ud-pr-0">
            <div>
              ...
              >
                <svg
                  viewBox="0 0 23 23"
                  class="ud-stroke-current dark:ud-hidden ud-w-5 ud-h-5 md:ud-w-6 md:ud-h-6"
                  fill="none"
                >
                  <path
                ...
                <svg
                  ...
                  class="ud-hidden dark:ud-block ud-w-5 ud-h-5 md:ud-w-6 md:ud-h-6"
                >
