    ...
    <div class="ud-container">
      <div class="ud-flex ud-flex-wrap ud-mx-[-16px]">
        <div class="ud-w-full ud-px-4 animated fadeIn">
          <div class="ud-max-w-[530px] ud-mx-auto ud-text-center">
            ...
            <p
              class="
                ud-font-medium ud-text-body-color ud-text-base
                sm:ud-text-lg
                ud-leading-relaxed
            ...
            <a
              ...
              class="
                ...
                lg:ud-px-8
                xl:ud-px-9
                hover:ud-bg-white hover:ud-text-primary
                ud-shadow-signUp ud-rounded-md
              "
            >
              Back to Homepage
            </a>
      ...
      <div
        class="
          ud-hidden
          sm:ud-block
          ud-absolute ud-left-0 ud-bottom-0 ud-z-[-1]
        "
      >
        <svg
          width="406"
