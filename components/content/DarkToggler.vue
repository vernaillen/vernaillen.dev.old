  ...
  >
    <ClientOnly>
      <UButton
        ...
        size="xs"
        class="!my-0 cursor-pointer text-primary-500 inline-flex dark:hidden"
      ...
      <UButton
        ...
        size="xs"
        class="!my-0 cursor-pointer text-primary-500 hidden dark:inline-flex"
      ...
      <template #fallback>
        <UButton
          ...
          size="xs"
          class="!my-0 inline-flex text-primary-500 opacity-40 animate-spin"
        />
      </template>
    </ClientOnly>
  </label>
